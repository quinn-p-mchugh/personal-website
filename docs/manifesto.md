...
- Everyone you will ever meet knows something you don't. How we perceive a someone's intelligence often reflects our own intellectual values intellectually, rather than the true amount, depth, or orginality of insight they can offer. In essence, when someone is labeled as "dumb", it doesn't mean they lack intelligence - it's just that the ways in which they're smart is overlooked or undervalued. In this way, we should all strive to be more [epistemically humble](https://en.m.wikipedia.org/wiki/Epistemic_humility).
