---
id: pim-architecture
title: Personal Information Management (PIM) Architecture
tags: [Personal Information Management (PIM), Personal Knowledge Management (PKM)]
sidebar_position: 3
---

import Drawio from "@theme/Drawio";
import pkmArchitecture from "!!raw-loader!./personal-information-management-pim-architecture.drawio";
...
## How I think of "productivity"? (Work in Progress)
...
## Personal Knowledge Management (PKM) Architecture (Work in Progress)
