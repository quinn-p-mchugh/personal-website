...
#sidebar_label: ""
slug: /autonomous-rotating-claw-mechanism
#description: ""
#keywords: []
tags: []
#image: ""
...
**Up Position:**
![Arm CAD - Up Position](autonomous-rotating-claw-mechanism-arm-cad-up-position.png)
![Arm CAD - Up Position Render](autonomous-rotating-claw-mechanism-arm-render-up-position.png)
![Arm - Up Position](autonomous-rotating-claw-mechanism-arm-up-position.png)

**Down Position:**
![Arm CAD - Down Position](autonomous-rotating-claw-mechanism-arm-cad-down-position.png)
![Arm CAD - Down Position Render](autonomous-rotating-claw-mechanism-arm-render-down-position.png)
![Arm - Down Position](autonomous-rotating-claw-mechanism-arm-down-position.png)

**Exploded View:**
![Arm CAD - Exploded View](autonomous-rotating-claw-mechanism-arm-cad-exploded-view.png)

**Graphical Linkage Synthesis:**
![Arm Graphical Linkage Synthesis](autonomous-rotating-claw-mechanism-arm-cad-graphical-linkage-synthesis.png)

### Claw
**Open Position:**
![Claw CAD - Open Position](autonomous-rotating-claw-mechanism-claw-cad-open.png)
![Claw CAD - Open Position Render](autonomous-rotating-claw-mechanism-claw-render-open.png)
![Claw - Open Position](autonomous-rotating-claw-mechanism-claw-open.png)

**Closed Position:**
![Claw CAD - Closed Position](autonomous-rotating-claw-mechanism-claw-cad-closed.png)
![Claw CAD - Closed Position Render](autonomous-rotating-claw-mechanism-claw-render-closed.png)
![Claw - Closed Position](autonomous-rotating-claw-mechanism-claw-closed.png)

**Exploded View:**
![Claw CAD - Exploded View](autonomous-rotating-claw-mechanism-claw-cad-exploded-view.png)

### Base
**Initial Position:**
![Base CAD - Initial Position](autonomous-rotating-claw-mechanism-base-cad-initial-position.png)
![Base CAD - Initial Position Render](autonomous-rotating-claw-mechanism-base-render-initial-position.png)

**Final Position:**
![Base CAD - Final Position](autonomous-rotating-claw-mechanism-base-cad-final-position.png)
![Base CAD - Final Position Render](autonomous-rotating-claw-mechanism-base-render-final-position.png)

**Exploded View:**
![Base CAD - Exploded View](autonomous-rotating-claw-mechanism-base-cad-exploded-view.png)

### Final Build
![Final Build](autonomous-rotating-claw-mechanism-final-build.png)

### "Claw Factory" Layout
![Final Layout - CAD Drawing](autonomous-rotating-claw-mechanism-base-layout-cad-drawing.png)
![Final Layout - Fabricated](autonomous-rotating-claw-mechanism-base-layout-fabricated.png)

### Code
![Arduino Code](autonomous-rotating-claw-mechanism-arduino-code.png)
